...
import Slide32IPRLecture from "./components/slides/Slide32IPRLecture";
import Slide33ShivajiJayanti from "./components/slides/Slide33ShivajiJayanti";
import Slide34ParentsMeeting from "./components/slides/Slide34ParentsMeeting";
import Slide35DebateCompetition from "./components/slides/Slide35DebateCompetition";
import Slide36BCAInduction from "./components/slides/Slide36BCAInduction";
import Slide37YouthDay from "./components/slides/Slide37YouthDay";
import Slide38SportsDay from "./components/slides/Slide38SportsDay";
import Slide39CyberSecurityWorkshop from "./components/slides/Slide39CyberSecurityWorkshop";
import Slide40InterviewLecture from "./components/slides/Slide40InterviewLecture";
import Slide41PlacementDrive from "./components/slides/Slide41PlacementDrive";
...
const SLIDES = [
  ...
  Slide13Research,
  Slide14Events,
  Slide26EventMediaCoverage,
  Slide16EventValueAddedCourse,
  Slide20EventCodingBootcamp,
  Slide37YouthDay,
  Slide15EventGuestLecture,
  Slide38SportsDay,
  Slide24EventCRT,
  Slide36BCAInduction,
  Slide23EventExtensionActivity,
  Slide35DebateCompetition,
  Slide34ParentsMeeting,  
  Slide39CyberSecurityWorkshop,
  Slide40InterviewLecture,
  Slide41PlacementDrive,
  Slide19EventInternationalPaperPresentation,
  Slide22EventOutreachActivity,
  Slide33ShivajiJayanti,
  Slide17EventIndustrialVisit,
  Slide21EventAnnualTechFest,
  Slide18EventSportsMeet,
  Slide25EventCET,
  Slide32IPRLecture,
  Slide31YaadeinEvent,
  // Slide27Future,
...
const IconMoon = () => (
  <svg viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.8">
    <path d="M17 13A7 7 0 1 1 7 3a5.5 5.5 0 0 0 10 10z" />
  </svg>
);
const IconGrid = () => (
  <svg viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.8">
...
export default function App() {
  ...
  const togglePlay = useCallback(() => {
    if (isPlaying) {
      ...
      resumePlay();
      showToast("▶ Auto-play resumed");
    }
  }, [isPlaying, pausePlay, resumePlay, showToast]);

  const toggleDark = useCallback(() => {
    setDarkMode((d) => {
      showToast(!d ? "🌙 Dark mode" : "☀️ Light mode");
      return !d;
    });
  }, [showToast]);
  ...
  const toggleFullscreen = useCallback(() => {
    if (!document.fullscreenElement) {
      ...
      showToast("⛶ Fullscreen — Esc to exit");
  ...
  return (
    <>
      ...
      {showMenu && (
        ...
        >
          <div
            className="glass-card-light menu-panel"
          ...
          >
            ...
            >
              ...
              <button className="hud-btn" onClick={() => setShowMenu(false)}>
                <IconClose />
              </button>
            </div>
